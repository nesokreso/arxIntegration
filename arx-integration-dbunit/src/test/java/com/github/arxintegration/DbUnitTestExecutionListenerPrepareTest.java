...
package com.github.arxintegration;
...
import com.github.arxintegration.DatabaseConnections;
import com.github.arxintegration.DbUnitTestExecutionListener;
import com.github.arxintegration.annotation.DatabaseOperation;
import com.github.arxintegration.annotation.DbUnitConfiguration;
import com.github.arxintegration.dataset.DataSetLoader;
import com.github.arxintegration.dataset.FlatXmlDataSetLoader;
import com.github.arxintegration.operation.DatabaseOperationLookup;
import com.github.arxintegration.operation.DefaultDatabaseOperationLookup;
	...
	public void shouldFailIfDatasetLoaderCannotBeCreated() throws Exception {
		...
		try {
			...
			assertEquals("Unable to create data set loader instance for class "
					+ "com.github.arxintegration.DbUnitTestExecutionListenerPrepareTest$"
