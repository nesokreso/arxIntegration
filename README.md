...
and should be used to construct the final connection. Here is a typical example:
    ...
    <bean id="dbUnitDatabaseConfig" class="com.github.arxintegration.bean.DatabaseConfigBean">
    	<property name="skipOracleRecyclebinTables" value="true"/>
    </bean>
    <bean id="dbUnitDatabaseConnection" class="com.github.arxintegration.bean.DatabaseDataSourceConnectionFactoryBean">
